...
\centering Table 5: ERCOT Linear Model Demographic Data \centering 
...
```{r Monthly Load Plot ERCOT, echo = FALSE, warning = FALSE, message = FALSE}
#Aggregrate by month 
...
```{r Monthly Load Plot PJM, echo = FALSE, warning = FALSE, message = FALSE}
#Aggregate by month
...
```{r Annual Growth ERCOT, echo = FALSE, warning = FALSE, message = FALSE}
```


```{r Annual Growth PJM, echo = FALSE, warning = FALSE, message = FALSE}
```
...
\centering Table 5: PJM Real-Time Linear Regression Values \centering
...
\centering Table 6: PJM Day-Ahead Linear Regression Values \centering
...
\centering Table 7: ERCOT Multiple Regression AIC Values \centering 
...
```{r Corr Plot, echo = FALSE, warning = FALSE, message = FALSE}
ercot.tot.Corr <- cor(ercot_linear_model_data_totprice)
corrplot(ercot.tot.Corr, method = 'ellipse', title = "Figure 6")
```
...
\centering Table 8: ERCOT Multiple Regression P-Values \centering
